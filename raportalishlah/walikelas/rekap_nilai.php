<?php
// walikelas/rekap_nilai.php
// Rekap nilai pengetahuan & keterampilan per mapel untuk wali kelas
...
<head>
    <meta charset="UTF-8">
    <title>Rekap Nilai Siswa - Wali Kelas</title>
    ...
    <div class="row mb-3">
        <div class="col-lg-10">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h2 class="h5 mb-1">Rekap Nilai Siswa Kelas <?= htmlspecialchars($kelasWali); ?></h2>
                    <p class="text-muted mb-1">
                        Menampilkan rata-rata nilai akhir Pengetahuan &amp; Keterampilan tiap mata pelajaran,
                        berdasarkan pengolahan KD oleh guru mapel.
                    </p>
                    ...
                    <thead>
                        ...
                        <tr class="table-light text-center align-middle">
                            <?php foreach ($mapelList as $m): ?>
                                ...
                                <th>Pred K</th>
                            <?php endforeach; ?>
                            <!-- kolom Aksi tidak ada sub-kolom -->
                        </tr>
                    </thead>
                    <tbody>
                        <?php
