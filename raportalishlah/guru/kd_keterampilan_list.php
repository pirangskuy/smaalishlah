...
if (empty($mapelList)) {
    ...
    // Ambil semua KD Keterampilan untuk mapel-mapel guru ini
...
<head>
    <meta charset="UTF-8">
    <title>Kelola KD Keterampilan</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body class="bg-light">

<div class="container mt-4">
    <h3>KD Keterampilan Mata Pelajaran Anda</h3>
    ...
    <?php else: ?>
        ...
        <a href="kd_keterampilan_add.php" class="btn btn-primary btn-sm mb-3">Tambah KD Keterampilan</a>
        ...
        <table class="table table-bordered table-striped table-sm">
            <thead class="table-dark">
                <tr>
                    ...
                    <th>Deskripsi KD Keterampilan</th>
                ...
                <?php if (empty($kdList)): ?>
                    <tr>
                        <td colspan="4" class="text-center text-muted">
                            Belum ada KD Keterampilan untuk mapel yang Anda ampu.
                        </td>
                    </tr>
                <?php else: ?>
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="kd_keterampilan_delete.php?id=<?= $kd['id']; ?>"
                                   class="btn btn-danger btn-sm"
                                   onclick="return confirm('Hapus KD keterampilan ini?');">
                                    Hapus
                                </a>
                            </td>
                        </tr>
